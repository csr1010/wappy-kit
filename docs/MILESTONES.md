...
| M13 | Session profile: facts + current state, TTL-bound | §5, §10 | M12 | A short, ambiguous reply composes sensibly using fresh session state, not just the last message |
